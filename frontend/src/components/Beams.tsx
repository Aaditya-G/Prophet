...
function extendMaterial<T extends THREE.Material = THREE.Material>(
  ...
  if ('envMap' in defaults) (uniforms as any).envMap.value = (defaults as any).envMap;
  if ('envMapIntensity' in defaults) (uniforms as any).envMapIntensity.value = (defaults as any).envMapIntensity;

  Object.entries(cfg.uniforms ?? {}).forEach(([key, u]) => {
    (uniforms as any)[key] =
      u !== null && typeof u === 'object' && 'value' in (u as any)
